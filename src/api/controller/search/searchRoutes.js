...
router.get( "/allbook/fuzzysearch", validation.validate(schema.fuzzySearch), searchController.fuzzySearch ); // to get all books by book name
router.post("/globalsearch", validation.validate(schema.globalSearch), searchController.globalSearch); // global search using regex
router.post("/globalfuzzysearch", validation.validate(schema.globalSearch), searchController.globalfuzzysearch); // global search using fuzzy
